...
import { DefaultQueryAttribute, Query } from "react-moralis/lib/utils/genericQuery";
import { UseResolveCallOptions } from "react-moralis/lib/hooks/internal/_useResolveAsyncCall";
...
export declare const useMoralisQuery: <Entity extends MoralisType.Attributes = MoralisType.Attributes>(nameOrObject: string | MoralisType.Object, queryMap?: (q: Query<Entity>) => Query<Entity>, dependencies?: unknown[], options?: UseMoralisQueryOptions<Entity>) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<MoralisType.Object<Entity>[], object>) => Promise<MoralisType.Object<Entity>[] | undefined>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
