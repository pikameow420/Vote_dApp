...
export declare const useWeb3Transfer: (params?: Web3TransferParameters | undefined, options?: UseWeb3TransferOptions | undefined) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<unknown, Web3TransferParameters>) => Promise<unknown>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
    data: unknown;
