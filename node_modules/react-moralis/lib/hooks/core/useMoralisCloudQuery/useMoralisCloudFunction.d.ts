...
export declare const useMoralisCloudFunction: (name: string, params?: MoralisCloudFunctionParameters | undefined, options?: UseMoralisCloudFunctionOptions | undefined) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<unknown, MoralisCloudFunctionParameters>) => Promise<unknown>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
    data: unknown;
