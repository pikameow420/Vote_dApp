...
export declare const useERC20Transfers: (params?: UseERC20TransfersParams | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    fetchERC20Transfers: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
