...
export declare const useTokenPrice: (params: UseTokenPriceParams, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    fetchTokenPrice: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<({
        nativePrice?: {
            value: string;
            decimals: number;
            name: string;
