...
export declare const useERC20Balances: (params?: UseERC20BalancesParams | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    fetchERC20Balances: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
