...
export declare const useNativeBalance: (params?: UseNativeBalancesParams | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    getBalances: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
        balance: string;
    } | null, {
        address: string;
