...
export declare const useNFTBalances: (params?: UseNFTBalancesParams | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    getNFTBalances: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
