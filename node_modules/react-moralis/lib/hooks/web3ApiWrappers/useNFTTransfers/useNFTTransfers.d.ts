...
export declare const useNFTTransfers: (params?: UseNFTTransfersParams | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    getNFTTransfers: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
        total: number;
        page: number;
        page_size: number;
        result: {
