...
export declare const useNativeTransactions: (params: UseNativeTransactionsParams, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    getNativeTransations: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<{
