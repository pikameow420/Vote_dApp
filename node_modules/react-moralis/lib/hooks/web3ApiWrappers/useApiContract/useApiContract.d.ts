...
export declare const useApiContract: ({ functionName, address, abi, chain, params }: ApiContractParams, options?: UseMoralisWeb3ApiCallOptions) => {
    runContractFunction: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("react-moralis/lib/hooks/internal/_useResolveAsyncCall").ResolveCallOptions<string | null, {
